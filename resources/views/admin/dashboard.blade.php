                ...
                <div>
                    ...
                    <div class="mt-6 flex gap-3">
                        <a href="{{ route('admin.categories') }}"
                            class="px-6 py-2.5 bg-white text-emerald-600 rounded-lg cursor-pointer font-semibold hover:bg-emerald-50 shadow-md hover:shadow-lg transition duration-200">
                            Get Started
                        </a>
                        <button
                            class="px-6 py-2.5 border-2 border-white text-white rounded-lg cursor-pointer hover:bg-white hover:text-emerald-600 shadow-md hover:shadow-lg transition duration-200 font-semibold"
