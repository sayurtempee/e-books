{{-- MODAL DETAIL BUYER - DESIGN MODERN CARD STYLE --}}
<div x-show="openDetailBuyerModal" x-transition:enter="transition ease-out duration-300"
    ...
    @keydown.escape.window="openDetailBuyerModal = false">

    {{-- MODAL BOX WITH CARD DESIGN --}}
    <div @click.away="openDetailBuyerModal = false" class="relative w-full max-w-sm mx-auto">

        {{-- CLOSE BUTTON (FLOATING TOP RIGHT) --}}
        <button @click="openDetailBuyerModal = false"
            ...
            <div class="relative bg-white px-6 pb-8 pt-2">
                ...
                {{--  <div class="mt-6 pt-4 border-t border-gray-100">
                    <div class="flex items-center justify-center gap-6 text-center">
                        <div>
                            <p class="text-lg font-bold text-teal-600">{{ $user->products_count ?? 0 }}</p>
                            <p class="text-xs text-gray-500">Produk</p>
                        </div>
                        <div class="w-px h-8 bg-gray-200"></div>
                        <div>
                            <p class="text-lg font-bold text-cyan-600">{{ $user->orders_count ?? 0 }}</p>
