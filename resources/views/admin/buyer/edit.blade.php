    ...
    <div @click.away="openEditBuyerModal = false"
        ...
        <div class="flex items-center justify-between mb-6">
            <div class="flex items-center gap-2">
                ...
                <h3 class="text-lg font-semibold text-gray-800">Edit Buyer</h3>
            </div>
        ...
        {{-- FORM --}}
        <form action="{{ route('admin.buyers.update', $user->id) }}" method="POST" enctype="multipart/form-data"
            ...
            <div>
                ...
                <textarea name="address" rows="2"
                    class="w-full p-4 rounded-xl bg-gray-100/80 border border-gray-200 focus:border-teal-500 focus:ring-teal-500 transition-all"
            ...
            <div class="flex justify-end gap-3 pt-2">
                ...
                <button type="submit" :disabled="loading"
                    ...
                    <span x-show="!loading">Update Buyer</span>
