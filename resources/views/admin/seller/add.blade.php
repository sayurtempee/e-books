{{-- MODAL ADD SELLER --}}
<div x-show="openAddSellerModal" x-transition:enter="transition ease-out duration-300"
    ...
    style="display: none;">
    {{-- MODAL BOX --}}
    <div @click.away="openAddSellerModal = false"
        ...
        <div class="flex items-center justify-between mb-6">
            ...
            <button @click="openAddSellerModal = false"
        ...
        {{-- FORM --}}
        <form action="{{ route('admin.sellers.create') }}" method="POST" x-data="{ loading: false }"
            ...
            <div class="flex justify-end gap-3 pt-4">
                <button type="button" @click="openAddSellerModal = false"
